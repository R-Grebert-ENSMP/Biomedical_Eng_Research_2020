...
# V_ini=7e-3
# Y,X,Z,PoT,DoT,T,QoT = expiration(links,nodes,t0=t0,DeltaT=delta_t,V_ini=7e-3,DeltaP=Delta_P,grad='adapt',stop_crit=eps)
...
# ax = fig.add_subplot(1,1,1) #SPIROGRAPHY
# ax.plot(LungVol,Debit,label='SANE INDIVIDUAL')
...
# ax.plot(LungVol,Debit,label='SEVERE COPD')
